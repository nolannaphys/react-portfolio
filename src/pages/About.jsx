    ...
    return (
        <>
            <div className="about-me">
                ...
                <p className='bio'>Greetings! I'm Nolan Naphys, a dedicated and creative full-stack web developer with a passion for crafting digital experiences that blend functionality with aesthetics. My journey into the world of programming began at the prestigious coding boot camp hosted by the University of Pennsylvania, where I honed my skills in both front-end and back-end technologies.
